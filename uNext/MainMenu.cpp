...
void MainMenu::Draw(SDL_Renderer* rR) {
	...
	Menu::Draw(rR);
	CCFG::getText()->Draw(rR, "©2019 POERTED TO THE NINTENDO SWITCH BY KRANK/KURANKU", 4, CCFG::GAME_HEIGHT - 4 - 10, 8, 0, 0, 0);
	CCFG::getText()->Draw(rR, "©2019 POERTED TO THE NINTENDO SWITCH BY KRANK/KURANKU", 5, CCFG::GAME_HEIGHT - 5 - 10, 8, 255, 255, 255);
