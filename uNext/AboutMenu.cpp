...
void AboutMenu::Draw(SDL_Renderer* rR) {
	...
	CCFG::getText()->DrawWS(rR, "SWITCH PORT BY KRANK/KURANKU", 150, 146, 0, 0, 0);

	CCFG::getText()->DrawWS(rR, "ALL RIGHT BELONGS TO NINTENDO", 150, 188, 0, 0, 0);
	//CCFG::getText()->DrawWS(rR, "UNIWERSYTET SLASKI W KATOWICACH", 150, 206, 0, 0, 0);
	//CCFG::getText()->DrawWS(rR, "MAJ 2014", 150, 224, 0, 0, 0);

	CCFG::getText()->DrawWS(rR, "2019", 150, 264, 0, 0, 0);
